  ...
  return (
    <div className="bg-white p-8 md:p-12 rounded-lg shadow-xl">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-ocean-blue-700 mb-6">Câu Chuyện Của Ocean Brew</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-coffee-brown-700 leading-relaxed">
              Ocean Brew Cafe ra đời từ tình yêu vô tận với hai thứ: cà phê hảo hạng và sự tĩnh lặng của đại dương. Chúng tôi mong muốn tạo ra một không gian nơi mọi người có thể tạm gác lại những bộn bề của cuộc sống, tìm thấy một chút bình yên và thưởng thức những ly cà phê được pha chế bằng cả trái tim.
            </p>
          </div>
        </div>
