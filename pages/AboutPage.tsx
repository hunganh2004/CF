    ...
    <div className="bg-white dark:bg-coffee-brown-900 p-8 md:p-12 rounded-lg shadow-xl">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            <h2 className="text-3xl font-bold text-coffee-brown-900 dark:text-coffee-brown-100 mb-4">Khởi Nguồn Từ Đam Mê</h2>
            <p className="text-coffee-brown-700 dark:text-coffee-brown-300 leading-relaxed">
        ...
        <div className="space-y-12 mb-16">
          <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
            <div className="bg-ocean-blue-100 dark:bg-ocean-blue-900/50 p-4 rounded-full">
              <Coffee size={40} className="text-ocean-blue-600 dark:text-ocean-blue-400" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-coffee-brown-900 dark:text-coffee-brown-100">Sứ Mệnh Của Chúng Tôi</h3>
              <p className="text-coffee-brown-700 dark:text-coffee-brown-300 mt-2">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8 text-center md:text-right">
            <div className="bg-ocean-blue-100 dark:bg-ocean-blue-900/50 p-4 rounded-full">
              <Anchor size={40} className="text-ocean-blue-600 dark:text-ocean-blue-400" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-coffee-brown-900 dark:text-coffee-brown-100">Giá Trị Cốt Lõi</h3>
              <p className="text-coffee-brown-700 dark:text-coffee-brown-300 mt-2">
        ...
        <div>
          <h2 className="text-3xl font-bold text-center text-coffee-brown-900 dark:text-coffee-brown-100 mb-8">Gặp Gỡ Đội Ngũ</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold dark:text-coffee-brown-100">Jane Doe</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold dark:text-coffee-brown-100">John Smith</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold dark:text-coffee-brown-100">Emily White</h4>
