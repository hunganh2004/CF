  ...
  return (
    <div className="bg-white dark:bg-neutral-gray-900 p-8 md:p-12 rounded-lg shadow-xl">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-sunset-orange-700 mb-6">Câu Chuyện Của Rocket Global</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            <h2 className="text-3xl font-bold text-neutral-gray-900 dark:text-neutral-gray-100 mb-4">Khởi Nguồn Từ Đam Mê</h2>
        ...
        <div className="space-y-12 mb-16">
          <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
            <div className="bg-sunset-orange-100 dark:bg-sunset-orange-900/50 p-4 rounded-full">
              <Coffee size={40} className="text-sunset-orange-600 dark:text-sunset-orange-400" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-neutral-gray-900 dark:text-neutral-gray-100">Sứ Mệnh Của Chúng Tôi</h3>
              <p className="text-neutral-gray-700 dark:text-neutral-gray-300 mt-2">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8 text-center md:text-right">
            <div className="bg-sage-green-100 dark:bg-sage-green-900/50 p-4 rounded-full">
              <Anchor size={40} className="text-sage-green-600 dark:text-sage-green-400" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-neutral-gray-900 dark:text-neutral-gray-100">Giá Trị Cốt Lõi</h3>
              <p className="text-neutral-gray-700 dark:text-neutral-gray-300 mt-2">
        ...
        <div>
          <h2 className="text-3xl font-bold text-center text-neutral-gray-900 dark:text-neutral-gray-100 mb-8">Gặp Gỡ Đội Ngũ</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold dark:text-neutral-gray-100">Jane Doe</h4>
              <p className="text-sunset-orange-600">Người Sáng Lập & Chuyên Gia Cà Phê</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold dark:text-neutral-gray-100">John Smith</h4>
              <p className="text-sunset-orange-600">Trưởng Barista</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold dark:text-neutral-gray-100">Emily White</h4>
              <p className="text-sunset-orange-600">Đầu Bếp Bánh</p>
            </div>
          </div>
        </div>
      </div>
