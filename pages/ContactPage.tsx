      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-coffee-brown-900 mb-4">Thông Tin Liên Hệ</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <MapPin className="text-ocean-blue-600 mt-1 flex-shrink-0" size={24} />
                  <div>
                    <h3 className="font-semibold">Địa chỉ</h3>
                    <p className="text-coffee-brown-700">123 Bờ Biển, TP. Đại Dương</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Phone className="text-ocean-blue-600 mt-1 flex-shrink-0" size={24} />
                  <div>
                    <h3 className="font-semibold">Điện thoại</h3>
                    <p className="text-coffee-brown-700">(012) 345-6789</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Mail className="text-ocean-blue-600 mt-1 flex-shrink-0" size={24} />
                  <div>
                    <h3 className="font-semibold">Email</h3>
                    <p className="text-coffee-brown-700">contact@rocketglobal.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-coffee-brown-900 mb-4">Giờ Mở Cửa</h2>
               <div className="flex items-start gap-4">
                  <Clock className="text-ocean-blue-600 mt-1 flex-shrink-0" size={24} />
                   <div className="text-coffee-brown-700">
