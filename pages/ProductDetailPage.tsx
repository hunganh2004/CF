...
const ProductDetailPage: React.FC = () => {
  ...
  if (!product) {
    return (
        <div className="text-center py-16">
            ...
            <p className="text-coffee-brown-700 dark:text-coffee-brown-300 mb-8">Chúng tôi không thể tìm thấy sản phẩm bạn yêu cầu.</p>
  ...
  return (
    <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-coffee-brown-900 p-6 md:p-8 rounded-lg shadow-xl grid md:grid-cols-2 gap-8">
            <div>
            ...
            <div className="flex flex-col justify-center">
                ...
                <h1 className="text-3xl md:text-4xl font-extrabold text-coffee-brown-900 dark:text-coffee-brown-100 mt-2 mb-4">{product.name}</h1>
                <p className="text-coffee-brown-700 dark:text-coffee-brown-300 leading-relaxed mb-6">{product.longDescription}</p>
